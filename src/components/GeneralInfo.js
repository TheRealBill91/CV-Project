...
export class GeneralInfoSection extends Component {
            ...
            this.setState((prevState) => {
                return {
                    generalData: {
                        ...
                        phoneInput: {
                            phoneNum: prevState.generalData.phoneInput.phoneNum,
                            phoneError: "Phone number must match format of (XXX) XXX-XXXX",
                            phoneInputValid: false,
                        },
                    },
                };
    ...
    submitGeneralInfo(e) {
        ...
        this.setState((prevState) => {
            console.log(prevState.generalData.emailInput.emailInputValid);
            if (
                !prevState.generalData.nameInput.nameInputValid ||
                !prevState.generalData.emailInput.emailInputValid ||
                !prevState.generalData.phoneInput.phoneInputValid
            ) {
                return;
            }
            return {
